TR = {
    ...
    "help": (
        "Сачу за чэргамі DUW Wrocław і паведамлю, калі набліжаецца твой талон.\n\n"
        "/queues — статус усіх чэргаў; зайдзі ў любую, каб падпісацца "
        "і ўказаць свой талон.\n"
        "/mysubs — усе твае падпіскі ў адным спісе.\n"
        "/dashboard — замацаванае паведамленне са статусам усіх тваіх чэргаў; "
        "абнаўляецца само.\n"
        "/stats — цеплавая карта па днях і гадзінах: калі меншы натоўп "
