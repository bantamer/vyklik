TR = {
    ...
    "help": (
        "Я слежу за очередями DUW Wrocław и пишу, когда подходит твоя очередь.\n\n"
        "/queues — статус всех очередей; зайди в любую, чтобы подписаться "
        "и указать свой билет.\n"
        "/mysubs — все твои подписки одним списком.\n"
        "/dashboard — закреплённое сообщение со статусом всех твоих очередей; "
        "обновляется само.\n"
        "/stats — тепловая карта по дням и часам: когда меньше народу "
        "и короче ожидание.\n"
